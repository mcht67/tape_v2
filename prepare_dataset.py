...
if __name__ == "__main__":
    ...
    if input_features and embeddings:
        ...
        if result.returncode == 0:
            ...
            print("Perch embedding script did not add embeddings.")
        else:
    ...
    if input_features and embeddings:
        ...
        if result.returncode == 0:
            ...
            print("Birdset embedding script did not add embeddings.")
        else:
            raise RuntimeError(f"birdset_embed_audio_stream.py failed with exit code {result.returncode}")

    # TDOD: remove stored locally in embedding scripts
    ###########################
    # Load dataset
    ###########################
